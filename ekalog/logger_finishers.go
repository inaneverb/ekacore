...
//
// Not bad, huh?
func (l *Logger) Log(level Level, args ...any) (this *Logger) {
...
func (l *Logger) Logf(level Level, format string, args ...any) (this *Logger) {
...
// Read more: Logger.Log().
func (l *Logger) Info(args ...any) (this *Logger) {
	return l.log(LEVEL_INFO, "", nil, args, nil)
}

// Infof is the same as Logf(LEVEL_INFO, format, args...).
// Read more: Logger.Logf().
func (l *Logger) Infof(format string, args ...any) (this *Logger) {
...
// Read more: Logger.Log().
func (l *Logger) Notice(args ...any) (this *Logger) {
	return l.log(LEVEL_NOTICE, "", nil, args, nil)
}

// Noticef is the same as Logf(LEVEL_NOTICE, format, args...).
// Read more: Logger.Logf().
func (l *Logger) Noticef(format string, args ...any) (this *Logger) {
...
// Read more: Logger.Log().
func (l *Logger) Warn(args ...any) (this *Logger) {
	return l.log(LEVEL_WARNING, "", nil, args, nil)
}

// Warnf is the same as Logf(LEVEL_WARNING, format, args...).
// Read more: Logger.Logf().
func (l *Logger) Warnf(format string, args ...any) (this *Logger) {
...
func (l *Logger) Warne(msg string, err *ekaerr.Error, kvFields ...any) (this *Logger) {
...
// Read more: Logger.Log().
func (l *Logger) Error(args ...any) (this *Logger) {
	return l.log(LEVEL_ERROR, "", nil, args, nil)
}

// Errorf is the same as Logf(LEVEL_ERROR, format, args...).
// Read more: Logger.Logf().
func (l *Logger) Errorf(format string, args ...any) (this *Logger) {
...
func (l *Logger) Errore(msg string, err *ekaerr.Error, kvFields ...any) (this *Logger) {
...
// Read more: Logger.Log().
func (l *Logger) Crit(args ...any) (this *Logger) {
	return l.log(LEVEL_CRITICAL, "", nil, args, nil)
}

// Critf is the same as Logf(LEVEL_CRITICAL, format, args...).
// Read more: Logger.Logf().
func (l *Logger) Critf(format string, args ...any) (this *Logger) {
...
func (l *Logger) Crite(msg string, err *ekaerr.Error, kvFields ...any) (this *Logger) {
...
// Read more: Logger.Log().
func (l *Logger) Alert(args ...any) (this *Logger) {
	return l.log(LEVEL_ALERT, "", nil, args, nil)
}

// Alertf is the same as Logf(LEVEL_ALERT, format, args...).
// Read more: Logger.Logf().
func (l *Logger) Alertf(format string, args ...any) (this *Logger) {
...
func (l *Logger) Alerte(msg string, err *ekaerr.Error, kvFields ...any) (this *Logger) {
...
// Read more: Logger.Log().
func (l *Logger) Emerg(args ...any) (this *Logger) {
...
// Read more: Logger.Logf().
func (l *Logger) Emergf(format string, args ...any) (this *Logger) {
...
func (l *Logger) Emerge(msg string, err *ekaerr.Error, kvFields ...any) (this *Logger) {
