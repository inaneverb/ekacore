...
func TestNewDateFromDays(t *testing.T) {
	require.Equal(t,
		...
		ekatime.NewDateFromDayOfYear(2021, 253).ToCmp(),
	)
	require.EqualValues(t,
		253,
		ekatime.NewDateFromDayOfYear(2021, 253).DayOfYear(),
	)
}
